...
# 들어가며.
## 💡 1. 프로젝트 소개
> 막연하게 이론으로만 공부하던 지식들을 한 번 구현을 해보고자 하였습니다.<br> 웹 프로그래밍의 기본 소양이라고 할 수 있는 게시판을 직접 만들어보고, 모르는 것은 검색하며 원하는 정보를 효과적으로 검색, 질문하는 방법 또한 함께 습득하고자 하였습니다.<br>
